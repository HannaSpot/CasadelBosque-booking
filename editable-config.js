const hotelConfig = {
  ...
  i18n: {
    en: {
      ...
      storyQuote: "A place where the jungle teaches you to breathe again.",
      storyQuoteCite: "— A guest's journal, 2025",
    ...
    es: {
      ...
      storyQuote: "Un lugar donde la selva te enseña a respirar de nuevo.",
      storyQuoteCite: "— Del diario de un huésped, 2025",
